        ...
        <div className="max-w-[1240px] mx-auto">
          <div className="text-center">
            ...
            <p className="text-3xl py-6 text-gray-600">
              ...
              quis, facere temporibus repellendus in tempore a animi
              consequuntur voluptatem labore ex placeat! Nisi iusto sequi
              dignissimos laboriosam, reprehenderit repellat itaque?
            </p>
          </div>
